    ...
    <div class="container mt-lg-2 ">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
                <!-- about company -->
                <div class="mb-4">
                    <img src="<?= e(app_url('assets/images/logo.png')); ?>" alt="CECOB" width="100" class="logo-inverse" />
                    <div class="mt-4">
                        <p>Association des Etudiants Congolais au Burundi.</p>
                        <!-- social media -->
                        <div class="fs-4 mt-4">
                            <!--Facebook-->
                            <a href="#" class="me-2">
            ...
            <div class="offset-lg-1 col-lg-2 col-md-3 col-6">
                <div class="mb-4">
                    <!-- list -->
                    <h3 class="fw-bold mb-3">Lien rapides</h3>
            ...
            <div class="col-lg-2 col-md-3 col-6">
                <div class="mb-4">
                    ...
                    <ul class="list-unstyled nav nav-footer flex-column nav-x-0">
                        <li><a href="#" class="nav-link">Aide et Support</a></li>
        ...
        <div class="row align-items-center g-0 border-top py-2 mt-6">
            ...
            <div class="col-lg-4 col-md-5 col-12">
                <span>
                    ...
                    CECOB. Association des Etudiants Congolais au Burundi.
                </span>
            </div>
